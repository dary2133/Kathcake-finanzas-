        ...
        <div className="space-y-10 animate-fade-in text-slate-900 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2 space-y-10">
                    {activeTab === 'profile' && (
                        <div className="card-premium p-12 space-y-12 border-none shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row gap-12 items-start relative z-10">
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 italic">Logo de la Empresa</label>
                                    <div className="relative group">
                                        <div className="w-48 h-48 bg-slate-50 border-2 border-dashed border-slate-200 rounded-[2.5rem] flex flex-col items-center justify-center overflow-hidden transition-all group-hover:border-primary-300 group-hover:bg-primary-50/10">
                                            {settings.logo ? (
                                                <img src={settings.logo} alt="Logo" className="w-full h-full object-contain p-4" />
                                            ) : (
                                                <div className="flex flex-col items-center gap-3 text-slate-300 group-hover:text-primary-400 transition-colors">
                                                    <ImageIcon className="w-12 h-12 opacity-20" />
                                                    <span className="text-[10px] font-black uppercase tracking-widest">Sin logo aún</span>
                                                </div>
                                            )}
                                                ...
                                                <input
                                                    ...
                                                    onChange={async (e) => {
                                                        ...
                                                        if (file) {
                                                            ...
                                                            formData.append('upload_preset', 'ml_default'); // Assuming cloudinary or similar
                                                            try {
                                        ...
                                        {settings.logo && (
                                            <button
                                                ...
                                                className="absolute -top-2 -right-2 p-2 bg-red-500 text-white rounded-full shadow-lg hover:scale-110 transition-transform z-20"
                                            >
                                                <X className="w-3 h-3" />
                                            </button>
                                        )}
                                ...
                                <div className="flex-1 w-full space-y-10">
                                    <div className="flex items-center gap-4 pb-8 border-b border-slate-50 relative z-10">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Identidad visual y contacto</p>
                                        </div>
                                    </div>
                            ...
                            <div className="pt-10 border-t border-slate-50 space-y-8 relative z-10">
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Redes sociales y sitio web</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="input-field h-14 pl-14 font-bold text-sm text-slate-900 border-slate-100 focus:border-pink-500 transition-all shadow-sm"
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 italic">Facebook</label>
                                        <div className="relative">
                                            <Facebook className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-600" />
                                            <input
                                                type="text"
                                                placeholder="facebook.com/tu_pagina"
                                                className="input-field h-14 pl-14 font-bold text-sm text-slate-900 border-slate-100 focus:border-blue-600 transition-all shadow-sm"
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 italic">Twitter / X</label>
                                        <div className="relative">
                                            <Twitter className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-900" />
                                            <input
                                                type="text"
                                                placeholder="@tu_empresa"
                                                className="input-field h-14 pl-14 font-bold text-sm text-slate-900 border-slate-100 focus:border-slate-900 transition-all shadow-sm"
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 italic">Sitio Web</label>
                                        <div className="relative">
                                            <Globe className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-primary-500" />
                                            <input
                                                type="url"
                                                placeholder="https://www.tu_empresa.com"
                                                className="input-field h-14 pl-14 font-bold text-sm text-slate-900 border-slate-100 focus:border-primary-500 transition-all shadow-sm"
