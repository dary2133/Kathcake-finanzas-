                    ...
                    <div className="space-y-8">
                        ...
                        <section id="kathcake" className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                            <div className="p-5 border-b border-slate-100 bg-emerald-50 flex justify-between items-center">
                                ...
                                <button onClick={() => { setEditingAccount(null); setShowAccountForm(!showAccountForm); }} className="text-xs bg-white border border-slate-200 hover:bg-emerald-50 text-slate-600 px-3 py-1.5 rounded-lg transition-colors font-medium">
                                    + Nueva
                                </button>
                            </div>
