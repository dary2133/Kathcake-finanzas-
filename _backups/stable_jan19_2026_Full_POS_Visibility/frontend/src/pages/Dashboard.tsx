                            ...
                            <tbody className="divide-y divide-slate-50">
                                {loading ? (
                                    ...
                                    <tr key={sale._id} className="hover:bg-slate-50/30 transition-all group cursor-pointer">
                                        ...
                                        <td className="px-10 py-6 text-center">
                                            <span className="px-4 py-1.5 bg-slate-100 text-slate-500 text-[8px] font-black rounded-full uppercase tracking-widest group-hover:bg-primary-500 group-hover:text-white transition-all">
