                                    ...
                                    <td className="px-8 py-6 text-center">
                                        <div className="flex items-center justify-center gap-2">
                                            {user.role === 'admin' ? (
                                                ...
                                                <>
                                                    {(user.permissions?.pos || (user.permissions as any)?.canCreateSales) && (
                                                        <div className="p-2 bg-emerald-50 text-emerald-500 rounded-xl" title="Ventas">
                                                            <ShoppingBag className="w-4 h-4" />
                                                        </div>
                                                    )}
                                                    {(user.permissions?.inventory || (user.permissions as any)?.canManageInventory) && (
                                                        <div className="p-2 bg-blue-50 text-blue-500 rounded-xl" title="Inventario">
                                                            <Package className="w-4 h-4" />
                                                        </div>
                                                    )}
                                                    {(user.permissions?.movements || (user.permissions as any)?.canViewReports) && (
                                                    ...
                                                    {(user.permissions?.settings || (user.permissions as any)?.canManageUsers) && (
